...
class BirthInfo extends Component {
   ...
   locationHandle() {
      const { p_bi_province_id, p_bi_district_id, p_bi_ward_id } = this.props.passProps.profileInfo;
      this.setState({
         selectedProvince: locationsFindItem('province', p_bi_province_id)[0],
         selectedDistrict: locationsFindItem('district', p_bi_district_id)[0],
         selectedWard: locationsFindItem('ward', p_bi_ward_id)[0]
      });
   }
            ...
            return (
               <DistrictList
                  ...
                  onSelectItem={item => this.setState({
                     ...
                     handleState('p_bi_district_id', item.district_id);
                     this.modal.hide();
                  })}
               />
            );
            ...
            return (
               <WardList
                  ...
                  onSelectItem={item => this.setState({
                     ...
                     handleState('p_bi_ward_id', item.ward_id);
                     this.modal.hide();
                  })}
               />
            );
            ...
            return (
               <ProvinceList
                  onSelectItem={item => this.setState({
                     ...
                     handleState('p_bi_province_id', item.province_id);
                     this.modal.hide();
                  })}
               />
            );
